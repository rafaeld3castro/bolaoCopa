		...
		model = new LazyDataModel<Participante>() {
			...
			public List<Participante> load(int inicio, int maxPerPage,
				...
				for (Participante participante : participanteList) {
					participante.setApostaGrupoPendente(apostaClassificacaoGrupoService.countByApostasPendentes(participante));
					participante.setApostJogoPendente(apostasService.countByParticipanteAndGolNull(participante));
				}
